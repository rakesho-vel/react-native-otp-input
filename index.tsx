...
> {
  ...
  renderOneInputField = (_: TextInput, index: number) => {
    const {
      ...
      dotContainerStyle,
      cursorColor,
      filledDotColor = "#000000",
      unFilledDotColor = "transparent",
    } = this.props;
      ...
      <View pointerEvents="none" key={index + "view"} testID="inputSlotView">
        <View
          style={[
            ...
            ,
            {
              backgroundColor: this.state.digits[index]
                ? filledDotColor
                : unFilledDotColor,
            },
            {
        ...
        <TextInput
          testID="textInput"
          selectionColor={cursorColor ? cursorColor : defaultCursorColor}
